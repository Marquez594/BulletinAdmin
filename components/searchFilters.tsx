...
export default function SearchFilters() {
  ...
  return (
    ...
    >
      ...
      {openDropDown && (
        <div className="top-14 w-48 h-fit bg-[#2a1f36] border border-gray-500 absolute rounded-xl flex flex-col justify-center items-start py-2 *:hover:cursor-pointer z-50">
          <button
